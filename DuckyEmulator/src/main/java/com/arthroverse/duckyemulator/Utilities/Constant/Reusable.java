...
public enum Reusable {
    ...
    private Reusable(ArrayList<String> welcomeLabelText){
        this.welcomeLabelText = welcomeLabelText;
    }
    ...
    public ArrayList<String> getAllWelcomeTexts(){
        return this.welcomeLabelText;
    }

    public static ArrayList<String> getSplashTexts() {
